...
//    // List to track available player numbers
//    //private List<int> availablePlayerNumbers = new List<int>();

//    // Dictionary to map ActorNumbers to PlayerNumbers
//    //private Dictionary<int, int> actorToPlayerNumber = new Dictionary<int, int>();
...
//    {
//        nickname = "Player " + nameCount.ToString();
//        nameCount++;
//    }
...
//        // Update custom properties with the player number
//        PhotonHashtable props = new PhotonHashtable
//    {
//        { "PlayerNumber", nameCount - 1 }
//    };
//        PhotonNetwork.LocalPlayer.SetCustomProperties(props);

//        Debug.Log($"Assigned PlayerNumber {nameCount - 1} to {PhotonNetwork.NickName}");

//        // Invoke RPC to inform all clients of this player's number
//        pv.RPC("SyncPlayerNumber", RpcTarget.AllBuffered, PhotonNetwork.LocalPlayer.ActorNumber, assignedPlayerNumber);
...
//        player.GetComponent<GetPlayerPhotonView>().RPC("SetNickname", RpcTarget.All, nickname);
//    }
